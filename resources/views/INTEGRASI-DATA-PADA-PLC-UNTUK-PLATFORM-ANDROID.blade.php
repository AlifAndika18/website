...
<head>
    <meta charset="UTF-8">
    <title>INTEGRASI DATA PADA PLC UNTUK
...
<body class="bg-black text-white min-h-screen flex flex-col items-center justify-center p-6">
    ...
    <h1 class="text-5xl font-bold text-center mb-8">INTEGRASI DATA PADA PLC UNTUK
    PLATFORM ANDROID</h1>
...
1. Mengintegrasikan PLC dengan Android dengan menggunakan API
sebagai komunikasi.</p>

<p class="text-lg leading-relaxed text-justify">
2. Membuat desain UI yang simple dan informatif.</p>

<p class="text-lg leading-relaxed text-justify">
3. Menggunakan proximity dan photoelectric sebagai alat untuk
menghitung dan memilah kualitas produk.</p>

<p class="text-lg leading-relaxed text-justify">
Berikut adalah cara kerja sistem ini:</p>
...
<img src="/images/plc.jpg" alt="Alif Andika Amin" class="w-[1000px] h-[400px] object-cover rounded-2xl shadow-lg border-4 border-white mt-6 inline-block">
...
<img src="/images/modbus.jpg" alt="Alif Andika Amin" class="w-[1000px] h-[400px] object-cover rounded-2xl shadow-lg border-4 border-white mt-6 inline-block">
...
<img src="/images/grafik.jpg" alt="Alif Andika Amin" class="w-[1200px] h-[1000px] object-cover rounded-2xl shadow-lg border-4 border-white mt-6 inline-block">
...
<p class="text-lg leading-relaxed text-justify mt-6 inline-block">
Dengan sistem ini, pengguna dapat melihat status mesin, mengatur parameter operasi, dan memantau performa sistem langsung dari aplikasi Android. Implementasi sistem berhasil meningkatkan keterhubungan antar perangkat serta memudahkan manajemen proses otomatisasi industri secara mobile dan praktis.</p>
